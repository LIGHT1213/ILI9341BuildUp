...
public:
    ...
    void ILI9341_DrawText(uint8_t *Text, uint8_t X, uint8_t Y, uint16_t Colour, uint16_t Size, uint16_t Background_Colour);
    void ILI9341_DrawChar(uint16_t, uint16_t, uint16_t, uint16_t, uint8_t *);
